...
**Acceptance Criteria:**
- [x] 앱 진입 시 랜덤 종 선택 (방문마다 새로 랜덤)
- [x] BirdCard: 새 사진 + 한국 공식명 표시
- [x] TriviaCard: 트리비아 1개 + 유형 레이블(생태/식별/계절) 표시
- [x] "퀴즈 시작" 버튼 클릭 시 모드 선택 → 퀴즈 진입
- [x] 모바일(375px) + PC(1280px) 레이아웃 정상
...
**Acceptance Criteria:**
- [x] 트리비아 유형 뱃지 표시 (생태 / 식별 / 계절)
- [x] 출처(`trivia_source`) 말줄임 + 탭 시 전체 표시
- [x] 종에 트리비아가 여러 개면 랜덤 1개 표시
